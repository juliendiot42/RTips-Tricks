...
R-Studio provide a lot of **very useful** commands linked to keyboard shortcuts. Even if it is not easy to learn, it will significantly improve your productivity.

The default shortcuts can be modify: `Tools -> Modify keyboard shortcuts...`

The list above is just a non-exhaustive list of my favorite shortcuts / R-Studio functionality.


<div class="note">
- Remember, if you are doing an annoying and repetitive task, there is probably a shortcut for that!
- The legend says that we don't need a mouse to work with a computer.
</div>
...
- `Ctrl` + `Alt` + `Shift` + `P` : Profile selected lines
